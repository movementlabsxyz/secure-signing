...
use anyhow::Context;
use secure_signer::cryptography::TryFromBytes;
use secure_signer::{cryptography::Curve, SignerError, Signing};
...
pub mod test {
	...
	use super::*;
	use secure_signer::{cryptography::ed25519::Ed25519, Signing, Verify};
